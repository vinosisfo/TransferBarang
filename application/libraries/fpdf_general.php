...
function Header(){    
    ...
    $this->Cell(0,0.6,'PT.RINNAI',0,1,'C');
    $this->Cell(0,0.6,'ALAMAT PT',0,1,'C');
    $this->Cell(0,0.6,'NO TLP PT',0,0,'C');
    $this->Cell(0,0.6,'Hal : '.$this->PageNo(),0,1,'C');
...
function Footer()
{
    ...
    // // Page number
    $this->Cell(0,10,'created by supriyono ',0,0,'L');
}
