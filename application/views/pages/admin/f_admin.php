          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="glyphicons">
              <div class="box">
                ...
                <form action="<?php echo base_url('c_admin/simpan_data')?>" method="POST">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="alamat" maxlength="200" minlength="10" class="form-control" style="width:30%"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <select name="level" class="form-control" style="width: 30%;" required="required">
