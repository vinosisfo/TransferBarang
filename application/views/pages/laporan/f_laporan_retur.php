      ...
      <div class="col-xs-12">
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
            <li class="active"><a href="#fa-icons" data-toggle="tab"><span class="badge bg-blue">Laporan Retur</span></a></li>
          </ul>
              ...
              <div class="box">               
                <div class="box-body scrolltable">
                  <div class="table-responsive">
                    <form action="<?php echo base_url('C_laporan/laporan_retur_view') ?>" method="post" id="form_lp">
