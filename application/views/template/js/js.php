...
<!-- js validate -->
<script src="<?php echo base_url('assets/AdminLTE-2.4.3/js/validate/jquery.validate.js')?>"></script>
<script src="<?php echo base_url('assets/AdminLTE-2.4.3/js/validate/jquery.validate.min.js')?>"></script>

<!-- front end -->
<script src="<?php //echo base_url('assets/front_shop/vendor/bootstrap/js/bootstrap.bundle.min.js')?>"></script>
